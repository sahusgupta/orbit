...
export const metadata: Metadata = createPageMetadata({ title: 'My Tournaments', description: 'Review your nonbinding Orbit tournament interests and upcoming event details.', path: '/me/tournaments', noIndex: true });
