...
export const metadata: Metadata = createPageMetadata({ title: 'Player profile', description: 'Manage the identity, location, stakes, availability, and eligibility details attached to your Orbit account.', path: '/me/profile', noIndex: true });
